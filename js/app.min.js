...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Изменение стилей хедера при прокрутке
    if (header && featuresSection) {
        function updateHeaderStyle() {
            const featuresSectionRect = featuresSection.getBoundingClientRect();
            const headerHeight = header.offsetHeight;
            
            // Если верхняя граница features-section выше или на уровне нижней границы хедера
            if (featuresSectionRect.top <= headerHeight) {
